...
import NewsCard from './NewsCard'; // Adjust the path if necessary

const Homepage = ({ category }) => {
  const [articles, setArticles] = useState([]);

  useEffect(() => {
    let url = `https://newsapi.org/v2/top-headlines?country=us&apiKey=661b33cdb6e64f39a2b404063a14a300`;
    ...
    <>
      <main>
        <section>
          ...
          <div className="horizontaline flex justify-center relative top-7 ">
          ...
          <footer>
            <div className="flex items-center justify-between relative border-t border-gray-200 bg-white px-4 py-3 sm:px-6" style={ { position: "relative", top: "760px" } }>
